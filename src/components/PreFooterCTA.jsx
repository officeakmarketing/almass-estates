    ...
    <section className="relative w-full py-40 flex flex-col items-center justify-center bg-[#030303] border-t border-white/5 overflow-hidden z-20">
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6">
        <Reveal className="flex items-center gap-4 mb-6">
          ...
          <span className="text-xs md:text-sm italic text-gray-400 font-light tracking-wide">Get started</span>
          <div className="w-10 md:w-16 h-[1px] bg-white/20"></div>
        </Reveal>
        ...
        <Reveal delay={200}>
          <p className="text-sm md:text-base text-gray-400 font-light mb-10">
            Join over 100 London landlords who never chase rent again.
          </p>
        </Reveal>

        <Reveal delay={300}>
          <a href="#assessment-form" className="group flex items-center gap-4 bg-white hover:bg-gray-200 text-black pl-6 pr-1.5 py-1.5 rounded-full font-sans font-medium transition-all duration-300 hover:scale-105">
